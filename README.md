...
curl -L -o install.sh "https://raw.githubusercontent.com/Depwisescript/Bot-telegram-ssh/refs/heads/main/install.sh" && chmod +x install.sh && sudo bash ./install.sh && rm install.sh
